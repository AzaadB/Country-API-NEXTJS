...
const CountryLink = (props) => ( //Send props over from Homepage component. // countryinfo? needs to match countryinfo.js the page name.
    <Link as={`/countries/${props.id}`} href={`/countries?common=${props.country.name.common}&pop=${props.country.population}&con=${props.country.continents}&curr=${props.curr}&flag=${props.country.flag}&arms=${props.country.coatOfArms.png}&lang=${props.lang}&cap=${props.country.capital}`}>
        <a style={anchor}>
